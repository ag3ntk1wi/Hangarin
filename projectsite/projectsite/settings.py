...
SECRET_KEY = 'django-insecure-o4315z_7+zv!hb764bd=xkyzq+_7!tvs%5wo^dr*_x9lb$-j*+'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['jmalate.pythonanywhere.com', '127.0.0.1', 'localhost']
...
if "pythonanywhere" in socket.gethostname():
    SITE_ID = 4 # production site (jmalate.pythonanywhere.com)
else:
...
LOGIN_URL = 'account_login' # where @login_required will send users
